                                ...
                                @forelse ($tahunAjarans as $ta)
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900">
                                            {{ $ta->nama }}</td>
                                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-700">
                                            {{ $ta->tanggal_mulai->format('d/m/Y') }}</td>
                                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-700">
                                            {{ $ta->tanggal_selesai->format('d/m/Y') }}</td>
                                        <td class="whitespace-nowrap px-6 py-4 text-sm">
                                            <span
                                                class="rounded-full px-2 py-1 text-xs font-semibold {{ $ta->is_active ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700' }}">
