<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">{{ __('Tambah Siswa') }}</h2>
    </x-slot>
                ...
                <form action="{{ route('siswa.store') }}" method="POST" class="p-6 space-y-4"
                        ...
                        <div>
                            ...
                            <select id="agama" name="agama"
                                ...
                                @foreach (['Islam', 'Kristen', 'Katolik', 'Hindu', 'Buddha', 'Konghucu'] as $a)
                                    <option value="{{ $a }}" @selected(old('agama') == $a)>{{ $a }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div>
                        ...
                        <x-text-input id="telp_orang_tua" name="telp_orang_tua" type="text"
                            class="mt-1 block w-full" :value="old('telp_orang_tua')" />
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select id="status" name="status"
                                ...
                                <option value="dropout" @selected(old('status') == 'dropout')>Drop Out</option>
                            </select>
                        </div>
