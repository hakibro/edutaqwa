<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">{{ __('Tambah Jurusan') }}</h2>
    </x-slot>

    <div class="py-12">
        <div class="mx-auto max-w-2xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <form action="{{ route('jurusan.store') }}" method="POST" class="p-6 space-y-4">
                    @csrf
                    ...
                    <div>
                        ...
                        <x-text-input id="nama" name="nama" type="text" class="mt-1 block w-full"
                            :value="old('nama')" required placeholder="contoh: IPA, IPS, TKJ, MM" />
                    ...
                    <div>
                        ...
                        <x-text-input id="kode" name="kode" type="text" class="mt-1 block w-full"
                            :value="old('kode')" placeholder="contoh: TKJ" />
