<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">{{ __('Tambah Pengumuman') }}</h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('pengumuman.store') }}" method="POST" id="pengumumanForm">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="konten_json" id="konten_json" class="hidden">{{ old('konten_json') }}</textarea>
                        ...
                        <div class="mb-4">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="is_active" value="1"
                                    ...
                                    checked>
                                <span class="ml-2 text-sm text-gray-600">Aktif (langsung tampil)</span>
                            </label>
                        </div>
...
<style>
    /* Editor.js output styling — matches rendered popup */
    ...
    (function() {
        function init() {
            ...
            const editor = new EditorJS({
                ...
                data: {!! old('konten_json') ? old('konten_json') : 'null' !!},
                onReady: function() {
